            ...
            <div className="contact__container container grid">
                <form action="" className="contact__form" id="contact-form">
                    <div className="contact__group">
                        ...
                        <input type="email" name="user_email" required placeholder="Enter your best email"  className="contact__input" />
                    </div>
                    <textarea name="user_project" required placeholder="Enter your message" className="contact__input"></textarea>
