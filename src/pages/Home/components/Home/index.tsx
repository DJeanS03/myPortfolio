                ...
                <div className="home__content">
                    <div className="home__data">
                        ...
                        <p className="home__description">
                            Dedicated to producing the finest digital experiences.With a deep love for technology and design, I dedicate my career to transforming creative concepts into intuitive and interactive web interfaces.
                        </p>
                ...
                <div className="home__image">
                    <svg className="home__blob" viewBox="0 0 550 591" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            ...
                            <image id="imageBlob" width="1040" height="1025" x="-170" y="-165"  href={imagem}/>
                        </defs>
                    </svg>
                </div>
            </div>
