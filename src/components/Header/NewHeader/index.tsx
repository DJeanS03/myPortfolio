...
const scrollActive = () => {
  ...
  sections.forEach((current: HTMLElement) => {
    ...
    const sectionsClassI: HTMLAnchorElement | null = document.querySelector(`.nav__menu a[href*= ${sectionId}] i`);
    const sectionsClassA: HTMLAnchorElement | null = document.querySelector(`.nav__menu a[href*= ${sectionId}]`);
